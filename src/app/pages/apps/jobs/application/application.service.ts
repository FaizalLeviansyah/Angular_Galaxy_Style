...
import { SortColumn, SortDirection } from './application-sortable.directive';
...
function sort(countries: ApplicationModel[], column: SortColumn, direction: string): ApplicationModel[] {
  if (direction === '' || column === '') {
    return countries;
  } else {
